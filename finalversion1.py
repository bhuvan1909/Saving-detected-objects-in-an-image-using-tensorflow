...
MODEL_NAME = os.path.join('cocotrained_models','ssd_mobilenet_v1_coco_2017_11_17')
    ...
    with tf.Session() as sess:
      ...
      if 'detection_masks' in tensor_dict:
        ...
        detection_masks_reframed = tf.cast(
            tf.greater(detection_masks_reframed, 0.50), tf.uint8)
...
for image_path in TEST_IMAGE_PATHS:
 ...
 #print([category_index.get(j)])
  #dataframe1=pd.DataFrame(savedclass)
  #dataframe1.to_csv("savedobjectsnet.csv",mode='a',index =False)
